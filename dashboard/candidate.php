<?php 
	session_start();
	include "../includes/databse_con.php";
	...
	if($_GET && isset($_GET['id'])) {
		$sql = "SELECT * FROM kandidat WHERE id='".$_GET['id']."'";
    ...
    <section class="content-grid">
    	<section>
    		...
    		<section class="grid-border">
    			...
    			<hr class="mtb-10">
    			<section class="text-center candiate-section">
    				<section>
    					<img class="rounded-circle img-profile profile-avatar" src="/assets/images/profile/<?= $candidate['img_url']?>">	
    				</section>
    				<section style="max-width: 600px; margin: 0 auto;">
    					<p><strong>Fakultet:</strong>  <?= $candidate['fakultet']?></p>
    					<p><strong>Institutt:</strong>  <?= $candidate['institutt']?></p>
    					<p><strong>Bruker epost:</strong>  <?= $candidate['bruker_epost']?></p>
    					<p><strong>Kandidat Col:</strong>  <?= $candidate['kandidatcol']?></p>
